...
class PlotMaps(object):
	...
	def vectorMap(self,proj_string, lon_arr, lat_arr, u_arr, v_arr, velocity, timestamp):
	...
	def vectorAnim(self,length, proj_string, show, save, savename, getU, getV, frameRate, lon_arr,lat_arr,u_arr, v_arr, velocity, time_array):
